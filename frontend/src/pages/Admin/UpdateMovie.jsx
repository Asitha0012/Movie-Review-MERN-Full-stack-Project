...
import { useGetSpecificMovieQuery, useUpdateMovieMutation, useUploadImageMutation, useDeleteMovieMutation } from '../../redux/api/movies';
...
const UpdateMovie = () => {
    ...
    const [movieData, setMovieData] = useState({
      ...
      return (
        <div className="relative flex justify-center items-start h-screen bg-cover bg-center" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1511875762315-c773eb98eec0?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)' }}>
         <div className="absolute inset-0 bg-black opacity-70"></div>
          ...
          <form>
            <p className="text-white w-[50rem] text-2xl mb-4 font-semibold">Update Movie</p>
