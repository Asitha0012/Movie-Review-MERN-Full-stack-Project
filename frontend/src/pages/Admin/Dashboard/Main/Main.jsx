      ...
      <section className="flex justify-around">
        <div className="ml-[16rem] mt-10">
          <div className="-translate-x-4 flex">
            <SecondaryCard pill="Users" content={visitors?.length}  gradient="from-teal-500 to-lime-400"/>
         
            <SecondaryCard  pill="Comments"  content={sumOfCommentsLength}  gradient="from-[#CCC514] to-[#CDCB8E]"/>
      
            <SecondaryCard  pill="Movies"  content={allMovies?.length}  gradient="from-green-500 to-lime-400"/>
